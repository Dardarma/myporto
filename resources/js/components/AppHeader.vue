...
import { BookOpen, Folder, Menu, Search, UserRound } from 'lucide-vue-next';
    ...
    <div>
        <div class="border-b border-sidebar-border/80">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <Link href="/admin/portfolio/profiles" class="flex items-center gap-x-2">
